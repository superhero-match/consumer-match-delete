...
type Health struct {
	...
	Port             string `env:"HEALTH_SERVER_PORT" default:":8030"`
	ShutdownEndpoint string `env:"HEALTH_SERVER_SHUTDOWN_ENDPOINT" default:"/api/v1/consumer_match_delete_health/shutdown"`
